                ...
                <div class="payment-option" id="accordion-parent">
                  <div class="payment-option__item">
                    <div class="payment-option__header">
                      ...
                      <img class="img-fluid payment-icon"
                        src="{{ asset('img/web/payment-icon-1.svg') }}" alt="payment-icon">
                  ...
                  <div class="payment-option__item">
                    <div class="payment-option__header">
                      ...
                      <img class="img-fluid payment-icon"
                        src="{{ asset('img/web/payment-icon-2.svg') }}" alt="payment-icon">
                  ...
                  <div class="payment-option__item">
                    <div class="payment-option__header">
                      ...
                      <img class="img-fluid payment-icon"
                        src="{{ asset('img/web/payment-icon-3.svg') }}" alt="payment-icon">
                              ...
                              <div class="card-form">
                                ...
                                <div class="card-form__detail">
                                  <div class="title">
                                    ...
                                    <div class="icon">
                                      <img class="img-fluid"
                                        src="{{ asset('img/web/card-icon-1.svg') }}" alt="icon">
                                      <img class="img-fluid"
                                        src="{{ asset('img/web/card-icon-2.svg') }}" alt="icon">
                                      <img class="img-fluid"
                                        src="{{ asset('img/web/card-icon-3.svg') }}" alt="icon">
                                      <img class="img-fluid"
                                        src="{{ asset('img/web/card-icon-4.svg') }}" alt="icon">
                                    </div>
                                  </div>
                                  <div class="body">
                                    <div class="form-group">
                                ...
                                <div class="content">
                                  <div class="bank-item">
                                    ...
                                    <img class="img-fluid bank-logo"
                                      src="{{ asset('img/web/bank-logo-1.png') }}" alt="bank-logo">
                                  </div>
                                  <div class="bank-item">
                                    <div class="form-group">
                                      <input class="form-check-input" type="radio" name="bankAtm"
                                    ...
                                    <img class="img-fluid bank-logo"
                                      src="{{ asset('img/web/bank-logo-2.png') }}" alt="bank-logo">
                                  </div>
                                  <div class="bank-item">
                                    <div class="form-group">
                                      <input class="form-check-input" type="radio" name="bankAtm"
                                    ...
                                    <img class="img-fluid bank-logo"
                                      src="{{ asset('img/web/bank-logo-3.png') }}" alt="bank-logo">
                                  </div>
                                  <div class="bank-item">
                                    <div class="form-group">
                                      <input class="form-check-input" type="radio" name="bankAtm"
                                    ...
                                    <img class="img-fluid bank-logo"
                                      src="{{ asset('img/web/bank-logo-4.png') }}" alt="bank-logo">
                                  </div>
                                  <div class="bank-item">
                                    <div class="form-group">
                                      <input class="form-check-input" type="radio" name="bankAtm"
                                    ...
                                    <img class="img-fluid bank-logo"
                                      src="{{ asset('img/web/bank-logo-5.png') }}" alt="bank-logo">
                                  </div>
                                  <div class="bank-item">
                                    <div class="form-group">
                                      <input class="form-check-input" type="radio" name="bankAtm"
                                    ...
                                    <img class="img-fluid bank-logo"
                                      src="{{ asset('img/web/bank-logo-6.png') }}" alt="bank-logo">
                                  </div>
                                  <div class="bank-item">
                                    <div class="form-group">
                                      <input class="form-check-input" type="radio" name="bankAtm"
                                    ...
                                    <img class="img-fluid bank-logo"
                                      src="{{ asset('img/web/bank-logo-7.png') }}" alt="bank-logo">
                                  </div>
                                  <div class="bank-item">
                                    <div class="form-group">
                                      <input class="form-check-input" type="radio" name="bankAtm"
                                    ...
                                    <img class="img-fluid bank-logo"
                                      src="{{ asset('img/web/bank-logo-8.png') }}" alt="bank-logo">
                                  </div>
                                  <div class="bank-item">
                                    <div class="form-group">
                                      <input class="form-check-input" type="radio" name="bankAtm"
                                    ...
                                    <img class="img-fluid bank-logo"
                                      src="{{ asset('img/web/bank-logo-9.png') }}" alt="bank-logo">
                                  </div>
                                  <div class="bank-item">
                                    <div class="form-group">
                                      <input class="form-check-input" type="radio" name="bankAtm"
                                    ...
                                    <img class="img-fluid bank-logo"
                                      src="{{ asset('img/web/bank-logo-10.png') }}"
                                      alt="bank-logo">
                                  </div>
                                  <div class="bank-item">
                                    <div class="form-group">
                                    ...
                                    <img class="img-fluid bank-logo"
                                      src="{{ asset('img/web/bank-logo-11.png') }}"
                                      alt="bank-logo">
                                  </div>
                                </div>
                              </div>
                              ...
                              <div class="bank-list">
                                ...
                                <div class="content">
                                  ...
                                  <div class="bank-item">
                                    ...
                                    <img class="img-fluid bank-logo"
                                      src="{{ asset('img/web/bank-logo-12.png') }}"
                                      alt="bank-logo">
                                  </div>
                                  <div class="bank-item">
                                    <div class="form-group">
                                    ...
                                    <img class="img-fluid bank-logo"
                                      src="{{ asset('img/web/bank-logo-13.png') }}"
                                      alt="bank-logo">
                                  </div>
                                  <div class="bank-item">
                                    <div class="form-group">
                                    ...
                                    <img class="img-fluid bank-logo"
                                      src="{{ asset('img/web/bank-logo-14.png') }}"
                                      alt="bank-logo">
                                  </div>
                                  <div class="bank-item">
                                    <div class="form-group">
                                    ...
                                    <img class="img-fluid bank-logo"
                                      src="{{ asset('img/web/bank-logo-15.png') }}"
                                      alt="bank-logo">
                                  </div>
                                  <div class="bank-item">
                                    <div class="form-group">
                                    ...
                                    <img class="img-fluid bank-logo"
                                      src="{{ asset('img/web/bank-logo-16.png') }}"
                                      alt="bank-logo">
                                  </div>
                                  <div class="bank-item">
                                    <div class="form-group">
                                  ...
                                  <div class="bank-item">
                                    ...
                                    <img class="img-fluid bank-logo"
                                      src="{{ asset('img/web/bank-logo-17.png') }}"
                                      alt="bank-logo">
                                  </div>
                                  <div class="bank-item">
                                    <div class="form-group">
                                    ...
                                    <img class="img-fluid bank-logo"
                                      src="{{ asset('img/web/bank-logo-18.png') }}"
                                      alt="bank-logo">
                                  </div>
                                  <div class="bank-item">
                                    <div class="form-group">
                                    ...
                                    <img class="img-fluid bank-logo"
                                      src="{{ asset('img/web/bank-logo-19.png') }}"
                                      alt="bank-logo">
                                  </div>
                                  <div class="bank-item">
                                    <div class="form-group">
                                    ...
                                    <img class="img-fluid bank-logo"
                                      src="{{ asset('img/web/bank-logo-20.png') }}"
                                      alt="bank-logo">
                                  </div>
                                  <div class="bank-item">
                                    <div class="form-group">
                                    ...
                                    <img class="img-fluid bank-logo"
                                      src="{{ asset('img/web/bank-logo-21.png') }}"
                                      alt="bank-logo">
                                  </div>
                                  <div class="bank-item">
                                    <div class="form-group">
                                    ...
                                    <img class="img-fluid bank-logo"
                                      src="{{ asset('img/web/bank-logo-22.png') }}"
                                      alt="bank-logo">
                                  </div>
                                  <div class="bank-item">
                                    <div class="form-group">
                                    ...
                                    <img class="img-fluid bank-logo"
                                      src="{{ asset('img/web/bank-logo-23.png') }}"
                                      alt="bank-logo">
                                  </div>
                                  <div class="bank-item">
                                    <div class="form-group">
                                    ...
                                    <img class="img-fluid bank-logo"
                                      src="{{ asset('img/web/bank-logo-24.png') }}"
                                      alt="bank-logo">
                                  </div>
                                  <div class="bank-item">
                                    <div class="form-group">
                                    ...
                                    <img class="img-fluid bank-logo"
                                      src="{{ asset('img/web/bank-logo-25.png') }}"
                                      alt="bank-logo">
                                  </div>
                                  <div class="bank-item">
                                    <div class="form-group">
                                    ...
                                    <img class="img-fluid bank-logo"
                                      src="{{ asset('img/web/bank-logo-26.png') }}"
                                      alt="bank-logo">
                                  </div>
                                  <div class="bank-item">
                                    <div class="form-group">
                                    ...
                                    <img class="img-fluid bank-logo"
                                      src="{{ asset('img/web/bank-logo-27.png') }}"
                                      alt="bank-logo">
                                  </div>
                                  <div class="bank-item">
                                    <div class="form-group">
                                    ...
                                    <img class="img-fluid bank-logo"
                                      src="{{ asset('img/web/bank-logo-28.png') }}"
                                      alt="bank-logo">
                                  </div>
                                  <div class="bank-item">
                                    <div class="form-group">
                                    ...
                                    <img class="img-fluid bank-logo"
                                      src="{{ asset('img/web/bank-logo-29.png') }}"
                                      alt="bank-logo">
                                  </div>
                                  <div class="bank-item">
                                    <div class="form-group">
                                    ...
                                    <img class="img-fluid bank-logo"
                                      src="{{ asset('img/web/bank-logo-30.png') }}"
                                      alt="bank-logo">
                                  </div>
                                </div>
                              </div>
