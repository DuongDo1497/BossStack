        ...
        <div class="review-carousel owl-carousel owl-theme">
          <div class="item">
            ...
            <div class="review-footer">
              <img class="img-fluid review-footer__avt" src="{{ asset('img/web/review-avt-2.jpg') }}" alt="avatar">
          ...
          <div class="item">
            ...
            <p class="review-content">“Là quản lý của một công ty xuất nhập khẩu nông sản, tôi đánh
              ...
              gia đình.”</p>
            <div class="review-footer">
              <img class="img-fluid review-footer__avt" src="{{ asset('img/web/review-avt-1.jpg') }}" alt="avatar">
              <div class="review-footer__info">
          ...
          <div class="item">
            ...
            <div class="review-footer">
              <img class="img-fluid review-footer__avt" src="{{ asset('img/web/review-avt-3.jpg') }}" alt="avatar">
              <div class="review-footer__info">
          ...
          <div class="item">
            ...
            <p class="review-content">“Sử dụng <b>phần mềm BossStack</b> cuối tháng tôi
              ...
              của mình.”</p>
            <div class="review-footer">
              <img class="img-fluid review-footer__avt" src="{{ asset('img/web/review-avt-4.jpg') }}" alt="avatar">
              <div class="review-footer__info">
...
<div class="section section-contact-us contact-us">
  <div class="container">
    <div class="wrap">
      ...
      @endif
      <form class="contact-us__form" action="{{ route('coaching-store') }}?continue=true" method="post" id="frm">
        {{ csrf_field() }}
