...
@section('content')
  ...
  <div class="section user-customer__edit">
    ...
    <form method="post" action="{{ route('usercustomers-update', ['id' => $model->id]) }}" role="form" id="frm">
      ...
      <div class="box-content">
        <div class="box box-primary">
          <div class="box-form">
            ...
            <div class="form-group">
              ...
              <select class="form-control select2" id="blocked" name="blocked" required>
                <option>Chọn trạng thái tài khoản</option>
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  <input type="text" class="form-control" name="begin_at" id="begin_at"
                    value="{{ ConvertSQLDate($model->begin_at) }}" placeholder="Chọn ngày" required>
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  <input type="text" class="form-control" name="finish_at" id="finish_at"
                    value="{{ ConvertSQLDate($model->finish_at) }}" placeholder="Chọn ngày" required>
                  <span class="input-group-addon">
                    <img src="{{ asset('img/icon-calender.svg') }}" alt="">
                  </span>
                </div>
          ...
          <div class="box-form">
            <div class="form-group">
              <label for="service_product_id">Gói dịch vụ đang kích hoạt<span>*</span>:</label>
              <select class="form-control select2" id="service_product_id" name="service_product_id"
                onchange="processChanged(this)" required>
                <option>Chọn mã khách hàng</option>
            ...
            <div class="form-group">
              <label for="approved_product">Trạng thái gói dịch vụ<span>*</span>:</label>
              <select class="form-control select2" id="approved_product" name="approved_product" required>
                <option>Chọn quyền truy cập</option>
            ...
            <div class="form-row">
              <div class="form-group">
                <label for="begin_at_product">Thời hạn gói dịch vụ từ ngày<span>*</span>:</label>
                <div class="input-group">
                  <input type="text" class="form-control" name="begin_at_product" id="begin_at_product"
                    value="{{ ConvertSQLDate($model->begin_at_product) }}" placeholder="Chọn ngày" required>
                  <span class="input-group-addon">
                    <img src="{{ asset('img/icon-calender.svg') }}" alt="">
                  </span>
                </div>
              ...
              <div class="form-group">
                <label for="finish_at_product">đến ngày<span>*</span>:</label>
                <div class="input-group">
                  <input type="text" class="form-control" name="finish_at_product" id="finish_at_product"
                    value="{{ ConvertSQLDate($model->finish_at_product) }}" placeholder="Chọn ngày" required>
                  <span class="input-group-addon">
                    <img src="{{ asset('img/icon-calender.svg') }}" alt="">
                  </span>
                </div>
  ...
  {{-- <div class="row">
    <div class="col-md-8">
      <div class="box box-primary">
        ...
        <form method="post" action="{{ route('usercustomers-update', ['id' => $model->id]) }}" role="form"
          id="frm">
          {{ csrf_field() }}
          {{ method_field('put') }}
          <input type='hidden' name='typereport' value=''>
          <div class="box-body">
            ...
            <div class="form-group">
              <div class="row">
                ...
                <div class="col-md-3">
                  <input type='text' class="form-control" name="begin_at" id='begin_at'
                    value="{{ ConvertSQLDate($model->begin_at) }}" />
                ...
                <div class="col-md-3">
                  <input type='text' class="form-control" name="finish_at" id='finish_at'
                    value="{{ ConvertSQLDate($model->finish_at) }}" />
            ...
            <div class="form-group">
              <div class="row">
                ...
                <div class="col-md-3">
                  <input type='text' class="form-control" name="begin_at_product" id='begin_at_product'
                    value="{{ ConvertSQLDate($model->begin_at_product) }}" />
                ...
                <div class="col-md-3">
                  <input type='text' class="form-control" name="finish_at_product" id='finish_at_product'
                    value="{{ ConvertSQLDate($model->finish_at_product) }}" />
