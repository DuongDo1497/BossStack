...
@section('content')
  ...
  <div class="section dashboard-admin no-bg">
    <div class="breadcrumb">
      <span>Quản lý khách hàng</span> / <span class="current">Tổng quan khách hàng</span>
    </div>
    <p class="title-page">{{ $title->heading }}</p>

    <form role="form" action="" method="get" name="frm" id="frm">
      <div class="box-content">
        <div class="box box-primary">
          <div class="noti-index">
            <div class="noti-index__wrap">
              <div class="noti-index__item">
                <p class="title">Tổng số khách hàng:</p>
          ...
          <div class="box-body">
            <div class="form-group">
              <div class="row" style="display: flex; justify-content: space-between; margin-bottom: 20px;">
                ...
                <div class="col-md-3">
                  <select class="form-control select2" name="periodtype" id="periodtype"
          ...
          <div class="box-body">
            <div class="form-group">
              <div class="row" style="display: flex; justify-content: space-between; margin-bottom: 20px;">
                ...
                <div class="col-md-3">
                  <select class="form-control select2" name="productperiodtype" id="productperiodtype"
                    onchange='document.frm.submit();'>
                    @foreach ($periodtypes as $key => $value)
                      @if ($key != 'd')
        ...
        <div class="box">
          <div class="box-body">
            <div class="quick-search">
              <div class="form-group">
                <input type="text" class="form-control" placeholder="Tìm kiếm nhanh" name="quick_search"
                  value="{{ $searchvalue }}">
                  ...
                  @foreach ($listcustomertype as $customer)
                    <tr class="table-customer">
                      ...
                      <td style="text-align: center;" class="text-nowrap">
                        {{ Carbon\Carbon::now()->year - substr($customer->birthday, 0, 4) }}</td>
                      <td style="text-align: left;" class="text-nowrap">{{ $customer->email }}</td>
                      <td style="text-align: left;" class="text-nowrap">{{ $customer->phone }}</td>
                      <td style="text-align: center;" class="text-nowrap">
                        {{ $customer->created_at == null ? '' : ConvertSQLDate($customer->created_at) }}</td>
                      <td style="text-align: center;" class="text-nowrap">{{ $customertype[$customer->customertype] }}
                      </td>
            ...
            <a href="{{ route('usercustomers-index') }}" style="display: block; margin-top: 10px; text-align: right;"
              target="blank">Danh sách chi tiết khách hàng &gt;&gt;</a>
          </div>
        </div>
      </div>
      <!-- <div class="col-md-5">
