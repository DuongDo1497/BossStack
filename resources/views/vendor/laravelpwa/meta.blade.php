...
<link rel="icon" sizes="{{ data_get(end($config['icons']), 'sizes') }}"
  href="https://bossstack.vn/public/images/icons/icon-512x512.png">
...
<div class="add-button">
  ...
  <img src="{{ asset('images/phone.png') }}" class="float-phone"><span
    style="margin-left: 20px;"><span style="font-weight: 700;" id="installapp">Bấm cài đặt APP
      ngay</span><br> để có thể truy cập nhanh hơn.</span>
...
<script>
  ...
  function showIosInstall() {
    ...
    txt_install.innerHTML =
      "Chọn <img width=15 src='{{ asset('images/action.png') }}'> và bấm <img width=20 src='{{ asset('images/add.png') }}'> cài APP";
