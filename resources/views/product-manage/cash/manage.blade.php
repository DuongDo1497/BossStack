                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                            ...
                            <table class="table table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="text-align: center;" class="text-nowrap" width="15%">TÊN KHÁCH HÀNG
                                        </th>
                                ...
                                <tbody>
                                    ...
                                    <tr class="table-customer">
                                        ...
                                        <td style="text-align: center;" class="text-nowrap">{{ $customer->contractdate
                                            == null ? "" : ConvertSQLDate($customer->contractdate) }}</td>
                                        ...
                                        <td style="text-align: left;" class="text-nowrap">
                                            ...
                                            <a class="detail"
                                                href="{{ route('cashplans-manage',['customer_id'=> Crypt::encrypt($customer->customer_id)]) }}">Chi
                                                tiết &gt;&gt;</a>
                                        </td>
                                        <td style="text-align: right;" class="text-nowrap"><b style="color: green;">{{
                                                formatNumber(0, 1, 0, 0) }}</b></td>
                                        <td style="text-align: center;" class="text-nowrap">{{ $customer->last_login_at
                                            == null ? "" : ConvertSQLDate($customer->last_login_at, 1) }}</td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
                        ...
                        <div class="box-footer clearfix text-right">
                            {{
                            $listcustomertype->appends(array('email'=>$email,'fullname'=>$fullname,'fromdate'=>$fromdate,
                            'todate'=>$todate,
                            'periodtype'=>$periodtype))->render('product-manage.cash.partials.pagination') }}
                        </div>
                    </div>
