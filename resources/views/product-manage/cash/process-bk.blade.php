  ...
  <div class="section cash-process">
    ...
    <form role="form" action="{{ route('cash-processPlan') }}" method="post" id="frm" name="frm">
      ...
      <div class="box-content">
            ...
            <div class="noti-index__wrap">
              <div class="noti-index__item">
                ...
                @foreach ($listaccounts as $item)
                  ...
                  @endphp
                @endforeach
                <p class="number">{!! formatNumberColor($total, 1, 0, 0) !!}</p>
              </div>
              <div class="noti-index__item">
                ...
                @foreach ($asset_1 as $cashasset)
                  ...
                  @endphp
                @endforeach
                <p class="number">{!! formatNumberColor($total + $totallistaccounts->sum('amount'), 1, 0, 0) !!}</p>
              </div>
              <div class="noti-index__item">
                ...
                @foreach ($asset_0 as $cashasset)
                  ...
                  @endphp
                @endforeach
                <p class="number">{!! formatNumberColorCustom($total, 1, 0, 0, 1) !!}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="box box-primary">
          <h6 class="box-title">Dòng tiền theo kế hoạch</h6>
          <div class="cash-process__wrap plan">
            ...
            <div class="tab-content">
              @for ($i = 0; $i < count($yearArray); $i++)
                <div id="schedulemonth_{{ $i }}" class="tab-pane fade {{ $i == 0 ? ' in active' : '' }}">
                  <table class="table table-bordered table-list" id="tablecashkehoach_{{ $i }}">
                    <thead>
                      @php
                        $icash = 1;
                      @endphp
                      <tr>
                        ...
                        <th rowspan="4">Thu Nhập</th>
                        <th rowspan="4">Chi Phí</th>
                        <th rowspan="4">Chi Trả Nợ</th>
                        @foreach ($listcashplan as $cashplan)
                          <th class="bg-gray">Mục tiêu {{ $icash++ }}</th>
                        @endforeach
                        <th rowspan="4" colspan="2">Chênh Lệch Dòng Tiền <br>(dự kiến)</th>
                      </tr>

                      <tr>
                        @foreach ($listcashplan as $cashplan)
                          <th class="bg-gray">{{ $cashplan->planname }} <br> {{ $cashplan->description }}
                            <br>Ngày lập:
                      ...
                      <tr>
                        @foreach ($listcashplan as $cashplan)
                          <th class="bg-gray planed-count">Kế hoạch:
                      ...
                      @foreach ($monthArray as $key => $value)
                        @if ($yearArray[$i] == $value)
                          <tr>
                            ...
                            <td class="text-right">{!! formatNumberColorCustom($dataArray[$key]['income'], 1, 0, 0, 0) !!}
                            </td>
                            <td class="text-right">{!! formatNumberColorCustom($dataArray[$key]['expense'], 1, 0, 0, 1) !!}
                            </td>
                            <td class="text-right">{!! formatNumberColorCustom($dataArray[$key]['bank'], 1, 0, 0, 1) !!}
                            </td>

                            @foreach ($listcashplan as $cashplan)
                              <td class="text-right bg-gray">{!! formatNumberColorCustom($dataArray[$key][$cashplan->id . '_planamount'], 1, 0, 0, 1) !!}</td>
                            @endforeach
                            ...
                            @endphp
                            <td colspan="2" style="color: {{ $color }};" class="text-right">
                    ...
                    @if ($i + 1 == count($yearArray))
                      <tfoot>
                        <tr>
                          <td class="text-left" colspan='2'>Tổng cộng
                          </td>
                          <td class="text-right">{!! formatNumberColorCustom($sumArray['income'], 1, 0, 0, 0) !!}</td>
                          <td class="text-right">{!! formatNumberColorCustom($sumArray['expense'], 1, 0, 0, 1) !!}</td>
                          <td class="text-right">{!! formatNumberColorCustom($sumArray['bank'], 1, 0, 0, 1) !!}</td>

                          @foreach ($listcashplan as $cashplan)
                            <td class="text-right bg-gray">{!! formatNumberColorCustom($sumArray[$cashplan->id . '_planamount'], 1, 0, 0, 1) !!}</td>
                          @endforeach
                          ...
                          <td colspan="2" style="color: {{ $color }}" class="text-right">
                            {!! formatNumber($sumArray['process_planamount'], 1, 0, 0) !!}</td>
                        </tr>
                      </tfoot>
                    @endif
                  </table>
        ...
        <div class="box box-primary">
          <h6 class="box-title">Dòng tiền đang thực hiện</h6>
          <div class="cash-process__wrap processing">
            <ul class="nav nav-tabs">
              @for ($i = 0; $i < count($yearArray); $i++)
                <li class="{{ $i == 0 ? ' active' : '' }}">
                    ...
                    <thead>
                      ...
                      <tr>
                        ...
                        @foreach ($listcashplan as $cashplan)
                          <th class="bg-gray">Mục tiêu {{ $icash++ }}</th>
                        @endforeach
                        <th rowspan="4">Chênh Lệch Dòng Tiền</th>
                      </tr>
                      ...
                      <tr>
                        @foreach ($listcashplan as $cashplan)
                          <th class="bg-gray">{{ formatNumber($cashplan->requireamount, 1, 0, 0) }}</th>
                        @endforeach
                      </tr>
                      ...
                      @foreach ($monthArray as $key => $value)
                        @if ($yearArray[$i] == $value)
                          <tr>
                            ...
                            <td class="text-right">{!! formatNumberColorCustom($dataArray[$key]['income'], 1, 0, 0, 0) !!}</td>
                            <td class="text-right">{!! formatNumberColorCustom($dataArray[$key]['expense'], 1, 0, 0, 1) !!}
                            </td>
                            <td class="text-right">{!! formatNumberColorCustom($dataArray[$key]['bank'], 1, 0, 0, 1) !!}</td>

                            @foreach ($listcashplan as $cashplan)
                              <td class="text-right bg-gray">{!! formatNumberColorCustom($dataArray[$key][$cashplan->id . '_realamount'], 1, 0, 0, 1) !!}</td>
                            @endforeach
                            ...
                            @endphp <td style="color: {{ $color }};" class="text-right">
                    ...
                    @if ($i + 1 == count($yearArray))
                      <tfoot>
                        <tr>
                          ...
                          @foreach ($listcashplan as $cashplan)
                            <td class="text-right bg-gray">{!! formatNumberColorCustom($sumArray[$cashplan->id . '_realamount'], 1, 0, 0, 1) !!}</td>
                          @endforeach
                          ...
                          <td style="color: {{ $color }}" class="text-right">{!! formatNumber($sumArray['process_realamount'], 1, 0, 0) !!}</td>
                        </tr>
                      </tfoot>
                    @endif
                  </table>
        ...
        <div class="box box-primary">
          <h6 class="box-title">Đánh giá khả năng thực hiện mục tiêu tài chính</h6>
          <div class="evaluate-performance">
                    ...
                    @foreach ($listcashplan as $cashplan)
                      ...
                      <tr>
                        <td class="fixed fixed-1">
                          ...
                          <p><span>Kế hoạch:</span> {{ formatNumber($cashplan->requireamount, 1, 0, 0) }}</p>
                        </td>
                      ...
                      <tbody>
                        ...
                        @foreach ($listaccounts as $item)
                          ...
                          <tr class="table-cashasset">
                            <td style="text-align: left;" class="text-nowrap">{{ $item->accountname }} <br>
                              {{ $item->accountno }}</td>
                      ...
                      <tfoot style="border: 1px solid #a6a6a6;">
                        <tr>
                          <td style="text-align: left;" class="text-nowrap" width="50%"><b>Tổng
                              cộng</b></td>
                          <td style="text-align: right;" class="text-nowrap" width="50%">
                            <b>{!! formatNumberColor($total, 1, 0, 1) !!}</b>
                          </td>
                        </tr>
                      </tfoot>
                    </table>
              ...
              <div class="row">
                <div class="col-md-12">
                  <table style="width: 100%;">
                    <tbody>
                      <tr>
                        <td style="text-align: left; font-size: 16px; color: #312f90;" class="text-nowrap"><b>SỐ TIỀN
                            CÁC
                            VÍ:</b></td>
                        <td style="text-align: right; font-size: 15px; color: #10aa25;" class="text-nowrap">
                          <b>{!! formatNumberColor($total, 1, 0, 0) !!}</b>
                        </td>
                      </tr>
                    </tbody>
                  </table>
              ...
              <div class="row">
                <div class="col-md-12">
                  <table style="width: 100%;">
                    <tbody>
                      <tr>
                        <td style="text-align: left; font-size: 16px; color: #312f90;" class="text-nowrap"><b>TỔNG TÀI
                            SẢN:</b></td>
                        <td style="text-align: right; font-size: 15px; color: #10aa25;" class="text-nowrap">
                          <b>{!! formatNumberColor($total + $totallistaccounts->sum('amount'), 1, 0, 0) !!}</b>
                        </td>
                      </tr>
                    </tbody>
                  </table>
                    ...
                    <table class="table">
                      <tbody>
                        ...
                        @foreach ($asset_0 as $cashasset)
                          ...
                          <tr class="table-cashasset">
                            <td style="text-align: left;" class="text-nowrap">{{ $i++ }}.
                              {{ $cashasset->assetname }}</td>
                            <td style="text-align: right;" class="text-nowrap">{!! formatNumberColorCustom($cashasset->remainamount, 1, 0, 0, 1) !!}
                            </td>
                          </tr>
                        @endforeach
                      </tbody>
                      <tfoot style="border: 1px solid #a6a6a6;">
                        <tr>
                          ...
                          @else
                            <td style="text-align: right;" class="text-nowrap" width="50%">
                              <b>{!! formatNumberColorCustom($total, 1, 0, 0, 1) !!}</b>
                            </td>
                          @endif
                        </tr>
                      </tfoot>
              ...
              <div class="row">
                <div class="col-md-12">
                  <table style="width: 100%;">
                    <tbody>
                      <tr>
                        <td style="text-align: left; font-size: 16px; color: #312f90;" class="text-nowrap"><b>TỔNG
                            NỢ:</b></td>
                        <td style="text-align: right; font-size: 15px; color: #ff423e;" class="text-nowrap">
                          <b>{!! formatNumberColorCustom($total, 1, 0, 0, 1) !!}</b>
                        </td>
                      </tr>
                    </tbody>
                      ...
                      <table class="table table-hover planned-cash" id="tablecashkehoach_{{ $i }}">
                        <thead>
                          ...
                          <tr>
                            ...
                            @foreach ($listcashplan as $cashplan)
                              <th
                                style="text-align: center; background: #dddddd;vertical-align: center;color: #2d3194;text-transform: capitalize;"
                          ...
                          <tr>
                            @foreach ($listcashplan as $cashplan)
                              <th style="text-align: left; background: #dddddd;vertical-align: center;;color: #10aa25;"
                                class="text-nowrap">{{ $cashplan->planname }} <br> {{ $cashplan->description }}
                                <br>Ngày lập:
                                {{ $cashplan->plandate == null ? '' : ConvertSQLDate($cashplan->plandate) }}
                              </th>
                            @endforeach
                          ...
                          <tr>
                            @foreach ($listcashplan as $cashplan)
                              <th
                                style="text-align: right; background: #dddddd;vertical-align: center;font-weight: 500;color: #10aa25;"
                                class="text-nowrap">
                                {{ formatNumber($cashplan->requireamount, 1, 0, 0) }}
                              </th>
                            @endforeach
                          ...
                          <tr>
                            @foreach ($listcashplan as $cashplan)
                              <th
                                style="text-align: left; background: #dddddd;vertical-align: center;font-weight: 500;color: #10aa25;"
                          ...
                          @foreach ($monthArray as $key => $value)
                            @if ($yearArray[$i] == $value)
                              <tr>
                                ...
                                <td style="text-align: right;" class="text-nowrap">{!! formatNumberColorCustom($dataArray[$key]['income'], 1, 0, 0, 0) !!}
                                </td>
                                <td style="text-align: right;" class="text-nowrap">{!! formatNumberColorCustom($dataArray[$key]['expense'], 1, 0, 0, 1) !!}
                                </td>
                                <td style="text-align: right;" class="text-nowrap">{!! formatNumberColorCustom($dataArray[$key]['bank'], 1, 0, 0, 1) !!}
                                </td>
                          ...
                          <tfoot>
                            <tr>
                              ...
                              <th colspan="2" style="text-align: right;color: {{ $color }}"
                                class="text-nowrap">{!! formatNumber($sumArray['process_planamount'], 1, 0, 0) !!}</th>
                            </tr>
                          </tfoot>
                        @endif
                      </table>
                        ...
                        <thead>
                          ...
                          <tr>
                            @foreach ($listcashplan as $cashplan)
                              <th
                                style="text-align: right; background: #dddddd;vertical-align: center;font-weight: 500;color: #10aa25;"
                                class="text-nowrap">{{ formatNumber($cashplan->requireamount, 1, 0, 0) }}</th>
                            @endforeach
                          </tr>
                            ...
                            @if ($yearArray[$i] == $value)
                              <tr>
                                ...
                                @endphp <td style="text-align: right;color: {{ $color }};"
                                  class="text-nowrap">{!! formatNumber($dataArray[$key]['process_realamount'], 1, 0, 0) !!}</td>
                              </tr>
                            @endif
                          @endforeach
                        </tbody>
                          ...
                          <tfoot>
                            <tr>
                              ...
                              @php
                                ...
                                if ($sumArray['process_realamount'] < 0) {
                                    $color = '#ff0000';
                              } @endphp <th style="text-align: right;color: {{ $color }}"
                                class="text-nowrap">{!! formatNumber($sumArray['process_realamount'], 1, 0, 0) !!}</th>
                            </tr>
                          </tfoot>
                        @endif
                      </table>
              ...
              <tbody>
                ...
                @foreach ($listcashplan as $cashplan)
                  ...
                  <tr>
                    ...
                    <td class="text-nowrap text-center"><span class="{{ $checkPlan }}"
                        style="font-size: 100%;">{{ $checkText }}</span></td>
                    <td class="text-nowrap text-left">
                      ...
                      <p style="margin-bottom: 5px; display: inline-block; margin-right: 20px;"><span
                          class="square success"></span>Đã thực hiện:
                        {{ formatNumber($percentProcess, 1, 0, 1) }}%</p>
                ...
                <tbody>
                  <tr>
                    ...
                    <td class="text-nowrap text-right">
                      <font style="color:#1eb40f; font-weight: bold;">{!! formatNumberColorCustom($total_requireamount, 1, 0, 0, 0) !!}</font>
                    </td>
                    <td class="text-nowrap text-right">
                      <font style="color:#1eb40f; font-weight: bold;">{!! formatNumberColorCustom($total_realamount, 1, 0, 0, 0) !!}</font>
                    </td>
