      ...
      <div class="news-wrap">
        ...
        <div class="items">
          <a href="{{ route('invests-detail', ['id' => $model->id]) }}">
            ...
            @else
            <div class="image">
              <img src="https://bossstack.vn/public/funds_manage/public/newfiles/files/No_Image_Available.jpg"
                width="100%">
            </div>
            <div class="info">
              <h4 class="name">{{ $model->newstitle }}</h4>
    ...
    <div class="news-wrap">
      ...
      <div class="items">
        ...
        <div class="info">
          <h4 class="name">{{ $model->newstitle }}</h4>
          <div class="editor">
            <span class="author">{{ $model->author }}</span><span class="dash">-</span><span class="date">{{
