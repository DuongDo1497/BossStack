...
@section('content')
  ...
  <div class="section cashplan-analysis">
    <div class="breadcrumb">
      <span>Quản lý tài khoản</span> / <span>Thiết lập ví tài chính</span> / <span
        class="current">{{ mb_strtoupper($plantypes[$model->plantype]) }}</span>
    </div>
    <p class="title-page">{{ $title->heading }}</p>

    <form role="form" action="{{ route('cashplans-update', ['id' => $model->id]) }}?continue=true"
  ...
  {{-- <div class="row">
    <form role="form" action="{{ route('cashplans-update', ['id' => $model->id]) }}?continue=true"
      ...
      <div class="col-md-12">
            ...
            <div class="financial-analysis">
              ...
              <div class="form-group">
                <div class="row">
                  ...
                  <div class="col-md-4 col-xs-7 item">
                    <input type="text" class="form-control" name="currentage"
              ...
              <div class="form-group">
                <div class="row">
                  ...
                  <div class="col-md-4 col-xs-7 item">
                    <input type="text" value="{{ $model->planage == '' ? 50 : $model->planage }}"
                      class="form-control" name="planage" id="planage"
              ...
              <div class="form-group" style="display: none;">
                <div class="row">
                  ...
                  <div class="col-md-4 col-xs-7 item" style="text-align: right;">
                    <font size="3" color='red'><b><span
                          id="totalcurrentamountlabel"></span></b></font>
                              ...
                              <thead>
                                <tr>
                                  ...
                                  <th style="text-align: center;" class="text-nowrap"
                                    width="8%">THÁNG</th>
                                  <th style="text-align: center;" class="text-nowrap"
                                    width="15%">TIỀN TÍCH LŨY MỖI THÁNG</th>
                                  <th style="text-align: center;" class="text-nowrap"
                                    width="15%">SỐ DƯ CUỐI KỲ</th>
                                </tr>
                              </thead>
                              <tbody>
                                @php
                              ...
                              <thead>
                                <tr>
                                  ...
                                  <th style="text-align: center;" class="text-nowrap"
                                    width="8%">TUỔI</th>
                                  <th style="text-align: center;" class="text-nowrap"
                                    width="15%">TIỀN TÍCH LŨY MỖI NĂM</th>
                                  <th style="text-align: center;" class="text-nowrap"
                                    width="15%">SỐ DƯ CUỐI KỲ</th>
                                </tr>
                              </thead>
        ...
        <a href="{{ route('cashplans-index') }}" style="width: 16%;"><i
