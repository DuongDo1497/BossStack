...
<script>
  ...
  currentamount.oninput = function() {
    ...
    total = parseFloat(removeCharacter(currentamount.value, ',')) * parseInt(currentamountunittype.value) +
      parseFloat(amount);
    if (!isNaN(total)) {
  ...
  if (total == 0) {
    ...
    total = parseFloat(removeCharacter(currentamount.value, ',')) * parseInt(currentamountunittype.value) + parseFloat(
      amount);
    if (!isNaN(total)) {
      totalcurrentamountlabel.innerHTML = formatCurrency(total);
      totalcurrentamount.value = formatCurrency(total);
