...
@section('content')
  ...
  <div class="section cashasset-add">
    ...
    <form role="form" action="{{ route('cashassets-store') }}?continue=true" method="post" id="frm"
      ...
      <div class="box-content">
        <div class="box box-primary">
          ...
          <div class="box-form">
            ...
            <div class="form-group">
              ...
              <select class="form-control select2" id="assettype" name="assettype"
                onChange="processSubmitOpenWindow('frm', 'view', '_top', '{{ route('cashassets-process', ['assetstatustype' => $assetstatustype]) }}', '1')"
                required>
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                <input type="text" class="form-control number" name="amount" id="amount" placeholder="Nhập..."
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="description" id="description" placeholder="Nhập..."
          ...
          <button class="btn btn-primary btn-save"
            onclick="processSubmitOpenWindow('frm', 'add', '_top', '{{ route('cashassets-store') }}?continue=true', '1')">Lưu</button>
        </div>
      </div>
    </form>
  </div>
        ...
        <div class="col-md-12">
            <div class="box box-primary">
                ...
                <div class="box-header with-border">
                    <font style="font-size:10pt;color='#000'">Nhập thông tin chi tiết các tài sản - nợ của khách hàng.
                        Để xem lại thông tin chi tiết các tài sản - nợ vui lòng xem <a
                            href="{{ route('cashassets-index') }}">tại đây</a>.</font>
                </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-4 col-xs-8 item">
                                <input type='text' class="form-control" name="assetname" id='assetname'
                                    value="{{ old('assetname') == "" ? $assetname : old('assetname') }}" />
