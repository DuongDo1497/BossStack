                ...
                <div class="box-form">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="assetname" id="assetname"
                            value="{{ old('assetname') == "" ? $assetname : old('assetname') }}" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="amount" id="amount" placeholder="Nhập..."
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="description" id="description"
                            placeholder="Nhập..." value="{{ old('description') }}">
                    </div>
                    <div class="form-group">
