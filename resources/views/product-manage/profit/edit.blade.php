        ...
        <div class="box box-primary">
          ...
          <div class="box-form">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                <input type="text" class="form-control number" name="doanhthuthuan" id="doanhthuthuan"
                  value="{{ formatNumber($model->doanhthuthuan, 1, 0, 0) }}" placeholder="Nhập..."
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                <input type="text" class="form-control number" name="doanhthutc_tnkhac" id="doanhthutc_tnkhac"
                  value="{{ formatNumber($model->doanhthutc_tnkhac, 1, 0, 0) }}" placeholder="Nhập..."
                  onkeyup='this.value=formatNumberDecimal(this.value)' required>
                <span class="input-group-addon">&#8363;</span>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="input-group">
                <input type="text" class="form-control number" name="tylegvhb_dt" id="tylegvhb_dt"
                  value="{{ formatNumber($model->tylegvhb_dt, 1, 0, 0) }}" placeholder="Nhập..."
                  onkeyup='this.value=formatNumberDecimal(this.value)' required>
                <span class="input-group-addon">&#37;</span>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="input-group">
                <input type="text" class="form-control number" name="tisuatloinhuankyvong"
                  id="tisuatloinhuankyvong" value="{{ formatNumber($model->tisuatloinhuankyvong, 1, 0, 0) }}"
