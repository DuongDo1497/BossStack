...
@section('content')
  ...
  <div class="section profit-index">
    ...
    <form role="form" action="{{ route('profits-updateConfig', ['id' => $model->id]) }}?continue=true" method="post"
      id="frm">
      {{ csrf_field() }}
      {{ method_field('put') }}
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                <input type="text" class="form-control number" name="chiphitaichinh" id="chiphitaichinh"
                  value="{{ formatNumber($model->chiphitaichinh, 1, 0, 0) }}" placeholder="Nhập..."
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                <input type="text" class="form-control number" name="chiphibanhang" id="chiphibanhang"
                  value="{{ formatNumber($model->chiphibanhang, 1, 0, 0) }}"
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                <input type="text" class="form-control number" name="chiphiquanlydoanhnghiep"
                  id="chiphiquanlydoanhnghiep" value="{{ formatNumber($model->chiphiquanlydoanhnghiep, 1, 0, 0) }}"
                  onkeyup='this.value=formatNumberDecimal(this.value)' required placeholder="Nhập...">
                <span class="input-group-addon">&#8363;</span>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="input-group">
                <input type="text" class="form-control number" name="chiphikhac" id="chiphikhac"
                  value="{{ formatNumber($model->chiphikhac, 1, 0, 0) }}"
                  onkeyup='this.value=formatNumberDecimal(this.value)' required placeholder="Nhập...">
                <span class="input-group-addon">&#8363;</span>
              </div>
            </div>
