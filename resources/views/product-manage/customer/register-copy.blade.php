          ...
          <div class="col-md-10 offset-md-1">
            <div class="card-group">
              ...
              <div class="card card-right">
                <div class="card-body">
                  <form role="form" action="{{ route('customers-addCustomer') }}?continue=true"
                    method="post" id="frm">
                    ...
                    <div class="box box-primary" style="margin-bottom: 30px;">
                      ...
                      <div class="box-body">
                        ...
                        <h2 class="text-center">
                          <font color="#2a3b8e">THÔNG TIN CÁ NHÂN</font>
                        </h2>
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group">
                              <label>Điện thoại <small class="text-danger text">
                                  (*)</small>:</label>
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              @if ($errors->has('contactname'))
                                <span
                                  class="text-danger">{{ $errors->first('contactname') }}</span>
                              @endif
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" tabindex="5"
                                name="contactphone" value="{{ old('contactphone') }}">
                              @if ($errors->has('contactphone'))
                                <span
                                  class="text-danger">{{ $errors->first('contactphone') }}</span>
                              @endif
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          <label>Nhóm khách hàng <small class="text-danger text">
                              (*)</small>:</label>
                        ...
                        <div class="form-group">
                          <div class="row">
                            <div class="col-md-12">
                              <label>Thông tin sản phẩm <small class="text-danger text">
                                  (*)</small>:</label>
                            </div>
                          </div>
                          <div class="row">
                            <div class="col-md-12">
                              <select class="form-control select2" name="typereport"
                                id="typereport" onchange='onChangeSelect();'>
                              ...
                              @if ($errors->has('typereport'))
                                <span
                                  class="text-danger">{{ $errors->first('typereport') }}</span>
                              @endif
                            </div>
                          </div>
                        </div>
                        ...
                        <div id="producttypelabel" style="">
                            ...
                            <div class="row">
                              <div class="col-md-12">
                                <select class="form-control select2" name="producttype"
                                  id="producttype" onchange='onChangeSelect();'>
                                ...
                                @if ($errors->has('producttype'))
                                  <span
                                    class="text-danger">{{ $errors->first('producttype') }}</span>
                                @endif
                              </div>
                            </div>
                          </div>
                          <div class="form-group">
                            <div class="row">
                              <div class="col-md-12">
                                &nbsp;Số tiền thanh toán: <font size="3" color='red'>
                                  <b><span id="amountlabel"></span></font> đồng.</b>
                              </div>
                            </div>
                          </div>
                    ...
                    <button type="submit" class="btn btn-success btn-register"><b>ĐĂNG
                        KÝ</b></button>
                  </form>
                </div>
              </div>
