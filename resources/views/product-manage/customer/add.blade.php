...
@section('content')
  ...
  <div class="row">
    <form role="form" action="{{ route('customers-store') }}?continue=true" method="post"
      id="customer-form">
      <div class="col-md-12">
        <div class="box box-primary">
          <div class="box-header with-border">
            ...
            <h4 class="box-title">
              <font color='#000080'>Thêm mới</font>
            </h4>
          </div>
          {{ csrf_field() }}
          <div class="box-body">
              ...
              <div class="row">
                ...
                <div class="col-md-2">
                  ...
                  @if ($errors->has('customercode'))
                    <span class="text-danger">{{ $errors->first('customercode') }}</span>
                  @endif
                </div>

                <div class="col-md-2 text-red text-right">
                  <label><u>TÀI KHOẢN ĐĂNG NHẬP</u> <small class="text-danger text">
                      (*)</small>:</label>
                </div>
                <div class="col-md-3">
            ...
            <div class="form-group">
              <label>
                <h5><u>II. NGUỒN THÔNG TIN BIẾT ĐẾN CHƯƠNG TRÌNH:</u></h5>
              </label>
            </div>
            <div class="form-group">
              <div class="row">
                ...
                <div class="col-md-7">
                  <input type="text" class="form-control" name="introduction_facebook"
                    value="{{ old('introduction_facebook') }}">
                </div>
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              <div class="row">
                ...
                <div class="col-md-2">
                  <input type='text' class="form-control" name="fatherbirthday"
                    id='fatherbirthday' value="{{ old('fatherbirthday') }}" />
                </div>
                <div class="col-md-1">
                  <label>Nghề nghiệp:</label>
                </div>
                <div class="col-md-2">
                  <input type="text" class="form-control" name="fatherwork"
                    value="{{ old('fatherwork') }}">
                </div>
                <div class="col-md-1">
                  <label>Người phụ thuộc: </label>
                </div>
                <div class="col-md-1">
                  <input type="checkbox" tabindex="4" name="fatherdependentperson"
                    value="1" id="chk-fatherdependentperson"
                    {{ old('fatherdependentperson') == 1 ? 'checked="checked"' : '' }}>
                </div>
              </div>
            </div>
            ...
            <div class="form-group">
              <div class="row">
                ...
                <div class="col-md-2">
                  <input type='text' class="form-control" name="motherbirthday"
                    id='motherbirthday' value="{{ old('motherbirthday') }}" />
                </div>
                <div class="col-md-1">
                  <label>Nghề nghiệp:</label>
                </div>
                <div class="col-md-2">
                  <input type="text" class="form-control" name="motherwork"
                    value="{{ old('motherwork') }}">
                </div>
                <div class="col-md-1">
                  <label>Người phụ thuộc: </label>
                </div>
                <div class="col-md-1">
                  <input type="checkbox" tabindex="4" name="motherdependentperson"
                    value="1" id="chk-motherdependentperson"
                    {{ old('motherdependentperson') == 1 ? 'checked="checked"' : '' }}>
                </div>
              </div>
            </div>
            <div class="form-group">
              <div class="row">
                ...
                <div class="col-md-2">
                  <input type='text' class="form-control" name="familybirthday"
                    id='familybirthday' value="{{ old('familybirthday') }}" />
                </div>
                <div class="col-md-1">
                  <label>Nghề nghiệp:</label>
                </div>
                <div class="col-md-2">
                  <input type="text" class="form-control" name="familywork"
                    value="{{ old('familywork') }}">
                </div>
              </div>
            </div>
            ...
            <div class="form-group">
              <div class="row">
                ...
                <div class="col-md-2">
                  ...
                  @if ($errors->has('customerstatustype'))
                    <span class="text-danger">{{ $errors->first('customerstatustype') }}</span>
                  @endif
                </div>
              ...
              <div class="row">
                ...
                <div class="col-md-2">
                  ...
                  @if ($errors->has('statustype'))
                    <span class="text-danger">{{ $errors->first('statustype') }}</span>
                  @endif
                </div>
                <div class="col-md-1"></div>
                <div class="col-md-2">
            ...
            <div class="form-group">
              <div class="row">
                ...
                <div class="col-md-2">
                  <input type='text' class="form-control" name="approved_at" id='approved_at'
        ...
        <br>
        <hr>
        <a href="{{ route('customers-index') }}" style="width: 16%;"><i
