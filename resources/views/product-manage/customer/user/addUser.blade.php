      ...
      <div class="box box-primary">
        <div class="box-form">
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="fullname" id="fullname" value="{{ old('fullname') }}" placeholder="Nhập..."
              required>
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="phone" id="phone" value="{{ old('phone') }}" placeholder="Nhập..."
              required>
            @if ($errors->has('phone'))
          ...
          <div class="form-group">
            ...
            <input type="email" class="form-control" name="email" id="email" value="{{ old('email') }}" placeholder="Nhập..."
              required>
            @if ($errors->has('email'))
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="birthday" id="birthday" value="{{ old('birthday') }}" placeholder="Nhập..." required>
