                ...
                <div class="payment-option__item">
                  <div class="payment-option__header">
                    <div class="form-group">
                      <input class="form-check-input" type="radio" name="ord_payment_method" value="0" checked="checked"
                              ...
                              <div class="card-form__detail">
                                <div class="title">
                                  ...
                                  <div class="icon">
                                    ...
                                    <img class="img-fluid" src="{{ asset('img/web/card-icon-3.svg') }}" alt="">
                                    <img class="img-fluid" src="{{ asset('img/web/card-icon-4.svg') }}" alt="">
                                  </div>
                                </div>
                                <div class="body">
                                  <div class="form-group">
                                  ...
                                  <div class="form-row">
                                    <div class="form-group">
                                      <input type="date" class="form-control" id="expirationCard" name="expirationCard"
                            ...
                            <div class="bank-list">
                              ...
                              <div class="content">
                                <div class="bank-item">
                                  ...
                                  <img class="img-fluid bank-logo" src="{{ asset('img/web/bank-logo-1.png') }}" alt="">
                                </div>
                                <div class="bank-item">
                                  <div class="form-group">
                                  ...
                                  <img class="img-fluid bank-logo" src="{{ asset('img/web/bank-logo-2.png') }}" alt="">
                                </div>
                                <div class="bank-item">
                                  <div class="form-group">
                                  ...
                                  <img class="img-fluid bank-logo" src="{{ asset('img/web/bank-logo-3.png') }}" alt="">
                                </div>
                                <div class="bank-item">
                                  <div class="form-group">
                                  ...
                                  <img class="img-fluid bank-logo" src="{{ asset('img/web/bank-logo-4.png') }}" alt="">
                                </div>
                                <div class="bank-item">
                                  <div class="form-group">
                                  ...
                                  <img class="img-fluid bank-logo" src="{{ asset('img/web/bank-logo-5.png') }}" alt="">
                                </div>
                                <div class="bank-item">
                                  <div class="form-group">
                                  ...
                                  <img class="img-fluid bank-logo" src="{{ asset('img/web/bank-logo-6.png') }}" alt="">
                                </div>
                                <div class="bank-item">
                                  <div class="form-group">
                                  ...
                                  <img class="img-fluid bank-logo" src="{{ asset('img/web/bank-logo-7.png') }}" alt="">
                                </div>
                                <div class="bank-item">
                                  <div class="form-group">
                                  ...
                                  <img class="img-fluid bank-logo" src="{{ asset('img/web/bank-logo-8.png') }}" alt="">
                                </div>
                                <div class="bank-item">
                                  <div class="form-group">
                                  ...
                                  <img class="img-fluid bank-logo" src="{{ asset('img/web/bank-logo-9.png') }}" alt="">
                                </div>
                                <div class="bank-item">
                                  <div class="form-group">
                                  ...
                                  <img class="img-fluid bank-logo" src="{{ asset('img/web/bank-logo-10.png') }}" alt="">
                                </div>
                                <div class="bank-item">
                                  <div class="form-group">
                                  ...
                                  <img class="img-fluid bank-logo" src="{{ asset('img/web/bank-logo-11.png') }}" alt="">
                                </div>
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="card-type__body collapse" id="card-type__banking" data-bs-parent="#accordion">
                            <div class="bank-list">
                              ...
                              <div class="content">
                                <div class="bank-item">
                                  <div class="form-group">
                                    <input class="form-check-input" type="radio" name="bankInternet" id="bankInternet1">
                                ...
                                <div class="bank-item">
                                  <div class="form-group">
                                    <input class="form-check-input" type="radio" name="bankInternet" id="bankInternet2">
                                ...
                                <div class="bank-item">
                                  <div class="form-group">
                                    <input class="form-check-input" type="radio" name="bankInternet" id="bankInternet3">
                                ...
                                <div class="bank-item">
                                  <div class="form-group">
                                    <input class="form-check-input" type="radio" name="bankInternet" id="bankInternet4">
                                ...
                                <div class="bank-item">
                                  <div class="form-group">
                                    <input class="form-check-input" type="radio" name="bankInternet" id="bankInternet5">
                                ...
                                <div class="bank-item">
                                  <div class="form-group">
                                    <input class="form-check-input" type="radio" name="bankInternet" id="bankInternet6">
                                ...
                                <div class="bank-item">
                                  <div class="form-group">
                                    <input class="form-check-input" type="radio" name="bankInternet" id="bankInternet7">
                                ...
                                <div class="bank-item">
                                  <div class="form-group">
                                    <input class="form-check-input" type="radio" name="bankInternet" id="bankInternet8">
                                ...
                                <div class="bank-item">
                                  <div class="form-group">
                                    <input class="form-check-input" type="radio" name="bankInternet" id="bankInternet9">
                                ...
                                <div class="bank-item">
                                  ...
                                  <img class="img-fluid bank-logo" src="{{ asset('img/web/bank-logo-12.png') }}" alt="">
                                </div>
                                <div class="bank-item">
                                  <div class="form-group">
                                    <input class="form-check-input" type="radio" name="bankInternet"
                                  ...
                                  <img class="img-fluid bank-logo" src="{{ asset('img/web/bank-logo-13.png') }}" alt="">
                                </div>
                                <div class="bank-item">
                                  <div class="form-group">
                                    <input class="form-check-input" type="radio" name="bankInternet"
                                  ...
                                  <img class="img-fluid bank-logo" src="{{ asset('img/web/bank-logo-14.png') }}" alt="">
                                </div>
                                <div class="bank-item">
                                  <div class="form-group">
                                    <input class="form-check-input" type="radio" name="bankInternet"
                                  ...
                                  <img class="img-fluid bank-logo" src="{{ asset('img/web/bank-logo-15.png') }}" alt="">
                                </div>
                                <div class="bank-item">
                                  <div class="form-group">
                                    <input class="form-check-input" type="radio" name="bankInternet"
                                  ...
                                  <img class="img-fluid bank-logo" src="{{ asset('img/web/bank-logo-16.png') }}" alt="">
                                </div>
                                <div class="bank-item">
                                  <div class="form-group">
                                    <input class="form-check-input" type="radio" name="bankInternet"
                                ...
                                <div class="bank-item">
                                  ...
                                  <img class="img-fluid bank-logo" src="{{ asset('img/web/bank-logo-17.png') }}" alt="">
                                </div>
                                <div class="bank-item">
                                  <div class="form-group">
                                    <input class="form-check-input" type="radio" name="bankInternet"
                                  ...
                                  <img class="img-fluid bank-logo" src="{{ asset('img/web/bank-logo-18.png') }}" alt="">
                                </div>
                                <div class="bank-item">
                                  <div class="form-group">
                                    <input class="form-check-input" type="radio" name="bankInternet"
                                  ...
                                  <img class="img-fluid bank-logo" src="{{ asset('img/web/bank-logo-19.png') }}" alt="">
                                </div>
                                <div class="bank-item">
                                  <div class="form-group">
                                    <input class="form-check-input" type="radio" name="bankInternet"
                                  ...
                                  <img class="img-fluid bank-logo" src="{{ asset('img/web/bank-logo-20.png') }}" alt="">
                                </div>
                                <div class="bank-item">
                                  <div class="form-group">
                                    <input class="form-check-input" type="radio" name="bankInternet"
                                  ...
                                  <img class="img-fluid bank-logo" src="{{ asset('img/web/bank-logo-21.png') }}" alt="">
                                </div>
                                <div class="bank-item">
                                  <div class="form-group">
                                    <input class="form-check-input" type="radio" name="bankInternet"
                                  ...
                                  <img class="img-fluid bank-logo" src="{{ asset('img/web/bank-logo-22.png') }}" alt="">
                                </div>
                                <div class="bank-item">
                                  <div class="form-group">
                                    <input class="form-check-input" type="radio" name="bankInternet"
                                  ...
                                  <img class="img-fluid bank-logo" src="{{ asset('img/web/bank-logo-23.png') }}" alt="">
                                </div>
                                <div class="bank-item">
                                  <div class="form-group">
                                    <input class="form-check-input" type="radio" name="bankInternet"
                                  ...
                                  <img class="img-fluid bank-logo" src="{{ asset('img/web/bank-logo-24.png') }}" alt="">
                                </div>
                                <div class="bank-item">
                                  <div class="form-group">
                                    <input class="form-check-input" type="radio" name="bankInternet"
                                  ...
                                  <img class="img-fluid bank-logo" src="{{ asset('img/web/bank-logo-25.png') }}" alt="">
                                </div>
                                <div class="bank-item">
                                  <div class="form-group">
                                    <input class="form-check-input" type="radio" name="bankInternet"
                                  ...
                                  <img class="img-fluid bank-logo" src="{{ asset('img/web/bank-logo-26.png') }}" alt="">
                                </div>
                                <div class="bank-item">
                                  <div class="form-group">
                                    <input class="form-check-input" type="radio" name="bankInternet"
                                  ...
                                  <img class="img-fluid bank-logo" src="{{ asset('img/web/bank-logo-27.png') }}" alt="">
                                </div>
                                <div class="bank-item">
                                  <div class="form-group">
                                    <input class="form-check-input" type="radio" name="bankInternet"
                                  ...
                                  <img class="img-fluid bank-logo" src="{{ asset('img/web/bank-logo-28.png') }}" alt="">
                                </div>
                                <div class="bank-item">
                                  <div class="form-group">
                                    <input class="form-check-input" type="radio" name="bankInternet"
                                  ...
                                  <img class="img-fluid bank-logo" src="{{ asset('img/web/bank-logo-29.png') }}" alt="">
                                </div>
                                <div class="bank-item">
                                  <div class="form-group">
                                    <input class="form-check-input" type="radio" name="bankInternet"
                                  ...
                                  <img class="img-fluid bank-logo" src="{{ asset('img/web/bank-logo-30.png') }}" alt="">
                                </div>
                              </div>
                            </div>
                          </div>
