  ...
  <div class="section customer-edit">
    ...
    <form role="form"
      ...
      <div class="box-content">
        ...
        <div class="box box-primary">
          <h6 class="box-title">Thay đổi thông tin bảo mật tài khoản</h6>
          <div class="box-form">
            {{-- <div class="form-group">
              <label for="fullname">Tên đầy đủ:</label>
              <input type="text" class="form-control" name="fullname" id="fullname"
            ...
            <div class="form-group">
              ...
              <input type="password" class="form-control" name="currentage" id="currentage"
                value="*********">
              <a class="change-pass" href="#changepassword" aria-expanded="false"
                data-toggle="collapse">[Đổi mật khẩu]</a>
            </div>
          </div>

          <div class="box-form collapse" id="changepassword">
            <div class="form-group">
                  ...
                  <div class="col-md-7 col-xs-12 item">
                    ...
                    <div class="box-body">
                      <div class="avatar-demo">
                        <img
                          src="{{ asset(empty($model->avatar) ? NO_IMAGE_URL : $model->avatar) }}"
                          class="img-circle" width="100%" height="100%" type="file"
                          name="be_image" value="{{ $model->avatar }}">
                      </div>
                    ...
                    <div class="box-header">
                      ...
                      <div class="box-tools" style="right: 0;">
                        <div class="btn-group btn-group-sm">
                          <a href="{{ route('customers-addFamilyRelationship') }}"
                            ...
                            <tr>
                              ...
                              <td style="text-align: center;" class="text-nowrap">
                                <a style="color: #1b1464;"
                                  href="{{ route('customers-editFamilyRelationship', ['id' => $item->id]) }}"
                                  title='Sửa'><i class="fas fa-pencil-alt"
                                    style="margin-right: 10px;"></i></a>
                                <a style="color: #1b1464;" href="javascript:void(0)"
                                  data-id="{{ $item->id }}" class="btn-delete"
