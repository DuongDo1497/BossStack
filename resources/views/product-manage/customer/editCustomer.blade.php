      ...
      <div class="box box-primary">
        ...
        <div class="box-form">
          ...
          <div class="form-group">
            ...
            <p class="form-text">Thông tin chi tiết khách hàng <a href="#customerinfo" aria-expanded="false"
                data-toggle="collapse">[Sửa]</a></p>
          </div>

          <div class="form-group">
            <label for="currentage">Mật khẩu:</label>
            <input type="password" class="form-control" name="currentage" id="currentage" value="*********">
            <a class="change-pass" href="#changepassword" aria-expanded="false" data-toggle="collapse">[Đổi mật
              khẩu]</a>
          </div>
        </div>
      </div>
      ...
      <div class="box box-primary collapse" id="customerinfo">
            ...
            <div class="box-form">
              ...
              <div class="form-row">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="gender" id="gender" value="{{ $model->gender }}">
                </div>
              </div>
        ...
        <div class="box-item">
          <div class="customer-avatar">
            <img src="{{ asset(empty($model->avatar) ? NO_IMAGE_URL : $model->avatar) }}" alt="{{ $model->fullname }}">
          </div>
          <div class="form-group">
            <div class="form-div">
