...
@section('content')
  ...
  <div class="section statistic-customer">
    <div class="breadcrumb">
      <span>Số liệu thống kê</span> / <span class="current">Đối tượng khách hàng</span>
    </div>
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    <div class="row">
                      ...
                      <div class="col-md-5">
                        <label>{{ $customertype[$typeMaxCustomer->customertype] }}
                          ({{ $typeMaxCustomer->countcustomer }})</label>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-7">
                      ...
                      <div class="col-md-5">
                        @if ($typeMinCustomer != null)
                          <label>{{ $customertype[$typeMinCustomer->customertype] }}
                            ({{ $typeMinCustomer->countcustomer }})</label>
                        @else
                          <label></label>
                        @endif
                      </div>
