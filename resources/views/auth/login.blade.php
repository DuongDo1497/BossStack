                      ...
                      <form action="{{ route('login') }}" method="post">
                        ...
                        <div class="form-group has-feedback">
                          <input type="email" class="form-control" placeholder="Email"
                            name="email" required="required" value="{{ env('TEST_USERNAME') }}">
                        ...
                        <div class="form-group has-feedback">
                          <div class="input-group" id="show_hide_password">
                            ...
                            <div class="input-group-addon">
                              <a href="" style="color:#777;"><i
                                  style="margin: 10px 10px 5px 10px;" class="fa fa-eye-slash"
                        ...
                        <div class="row">
                          <div class="col-md-5 col-5">
                            <input type="captchacode" class="form-control" placeholder="Mã kiểm tra"
                              name="captchacode" required="required" value="">
                          </div>
                          <div class="col-md-4 col-4">
                            <img id="captcha" name="captcha"
                              src="{{ route('apiadmin-getCaptcha') }}">
                          </div>
                        </div>
                        <div class="form-group has-feedback">
                          <div class="forgot-password">
                            <a href="{{ route('customers-forgotPassword') }}"
                              class="card-link"><b>Quên mật khẩu?</b></a>
                          </div>
                        </div>

                        <button type="submit" class="btn btn-primary btn-login"
                          style="width: 100%;"><b>ĐĂNG NHẬP</b></button>
                      </form>

                      <p class="text-center" style="margin: 20px 0;"><b>Bạn có tài khoản chưa?</b>
                      </p>

                      <a href="{{ route('customers-register', ['service_product_id' => 1]) }}"
                        class="btn btn-primary btn-register"
                        style="width: 100%; font-size: 1rem !important;"><b>ĐĂNG KÝ</b></a>
                    </div>
                  </div>
                </div>
              </div>
