...
class Customer extends BaseModel
{
     ...
     */
    protected $fillable = [
        'user_id','customercode','avatar','fullname','birthday','gender','maritalstatus','address','phone','email','contactname','contactphone','introduction_facebook','introduction_email','introduction_user','introduction_orther','fathername','fatherbirthday','fatherwork','fatherdependentperson','mothername','motherbirthday','motherwork','motherdependentperson','familyname','familybirthday','familywork','childrenname','customertype','personalcashflow','invest','saving','financial','customerstatustype','officer_user_id','approved','approved_user_id','approved_at','approvestatustype','relationshiptype','usercustomertype','dependent','created_user_id','created_at','updated_user_id','updated_at'
    ];
